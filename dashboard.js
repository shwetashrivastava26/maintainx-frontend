...
const defaultMachines = [
  ...
  { code:"GM005", block:"Generator Manufacturing", machine:"Stator Core Assembly Machine",  status:"Active" },
  { code:"TD001", block:"Transformer Division",    machine:"Core Cutting Machine",          status:"Active" },
  { code:"TD002", block:"Transformer Division",    machine:"Coil Winding Machine",          status:"Active" },
  { code:"TD003", block:"Transformer Division",    machine:"Oil Filtration Plant",          status:"Active" },
  { code:"TD004", block:"Transformer Division",    machine:"Vacuum Drying Oven",            status:"Active" },
  { code:"TD005", block:"Transformer Division",    machine:"Transformer Testing Bench",     status:"Due Maintenance" },
  { code:"FS001", block:"Fabrication Shop",        machine:"Plasma Cutting Machine",        status:"Active" },
  { code:"FS002", block:"Fabrication Shop",        machine:"CNC Laser Cutter",              status:"Active" },
  { code:"FS003", block:"Fabrication Shop",        machine:"Heavy Duty Welding Station",    status:"Active" },
  { code:"FS004", block:"Fabrication Shop",        machine:"Plate Rolling Machine",         status:"Due Maintenance" },
  { code:"MS001", block:"Machine Shop",            machine:"Universal Milling Machine",     status:"Active" },
  { code:"MS002", block:"Machine Shop",            machine:"Surface Grinding Machine",      status:"Active" },
  { code:"MS003", block:"Machine Shop",            machine:"Gear Hobbing Machine",          status:"Under Repair" },
  { code:"TF001", block:"Testing Facilities",      machine:"High Voltage Test Bench",       status:"Active" },
  { code:"TF002", block:"Testing Facilities",      machine:"Load Test Rig",                 status:"Overdue" },
  { code:"TF003", block:"Testing Facilities",      machine:"Vibration Analysis System",     status:"Active" }
];
